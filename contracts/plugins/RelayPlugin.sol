...
// for the gelatonetwork relay context there was an error in the TokenUtils 
// where it uses safePermit of openzeppelin IERC20Permit instead of permit. I made a change in that file.

address constant NATIVE_TOKEN = 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE;

abstract contract RelayPlugin is BasePluginWithEventMetadata {
